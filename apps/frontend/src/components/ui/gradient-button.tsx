  ...
  return (
    <button
      className={cn(
        ...
        {
          // Primary variant
          'bg-gradient-to-r from-purple-600 via-purple-600 to-purple-700 text-white shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30': variant === 'primary',
          // Secondary variant
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-purple-600 to-purple-700 opacity-0 transition-opacity duration-300 hover:opacity-100" />
